        ...
        <div className='grid grid-cols-2 md:grid-cols-5 gap-8 md:gap-12'>
          ...
          <div className='col-span-2 md:col-span-1'>
            ...
            <p className='text-gray-400 text-sm leading-relaxed'>
              {language === "uk" 
                ? "Автоматизуй свій аналіз ринку за допомогою потужних аналітичних моделей."
                : "Automate your market analysis with powerful analytical models."}
            </p>
          ...
          <div className='col-span-2 md:col-span-1'>
            ...
            <div className="text-sm text-gray-400 space-y-3">
              ...
              <p className="text-gray-500">{language === "uk" ? "Код: 46116338" : "Code: 46116338"}</p>
