...
export default function ConnectExchangeModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-xl p-6 w-[92%] max-w-md space-y-3"
      ...
      >
        ...
        <p className="text:[12px] text-gray-600">
          Keys are stored encrypted locally (AES-256-GCM) and used by the local
          server only to fetch balances.
        </p>
      </div>
    </div>
  );
